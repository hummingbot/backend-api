...
async def get_all_accounts_state(wa: WalletAuthDep):
    return accounts_service.get_accounts_state()


@router.get("/account-state-history", response_model=List[Dict])
async def get_account_state_history(wa: WalletAuthDep):
    """
...
async def add_account(account_name: str, wa: WalletAuthDep):
    try:
...
async def delete_account(account_name: str, wa: WalletAuthDep):
    try:
...
async def delete_credential(account_name: str, connector_name: str, wa: WalletAuthDep):
    try:
...
async def add_connector_keys(account_name: str, connector_name: str, keys: Dict, wa: WalletAuthDep):
    try:
