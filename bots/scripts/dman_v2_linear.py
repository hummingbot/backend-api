...
class DManV2ScriptConfig(BaseClientModel):
    ...
    stop_loss: Decimal = Field(
        ...
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Set the stop loss percentage (e.g., 0.2 for 20% loss):",
        ),
    )
    take_profit: Decimal = Field(
        ...
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Enter the take profit percentage (e.g., 0.06 for 6% gain):",
        ),
    )
    ...
    trailing_stop_trailing_delta: Decimal = Field(
        ...
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Set the trailing delta for the trailing stop (e.g., 0.003 for 0.3%):",
        ),
    )
