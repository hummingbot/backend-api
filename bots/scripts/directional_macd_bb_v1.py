...
class DirectionalTradingMACDBBConfig(BaseClientModel):
    ...
    macd_fast: int = Field(
        21,
        client_data=ClientFieldData(
            prompt_on_new=True, prompt=lambda mi: "Set the MACD fast length (e.g., 21):"
        ),
    )
    macd_slow: int = Field(
        42,
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Specify the MACD slow length (e.g., 42):",
        ),
    )
    ...
    bb_length: int = Field(
        ...
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Enter the Bollinger Bands length (e.g., 100):",
        ),
    )
    bb_std: float = Field(
        2.0,
    ...
    bb_long_threshold: float = Field(
        ...
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Specify the long threshold for Bollinger Bands (e.g., 0.3):",
        ),
    )
    bb_short_threshold: float = Field(
        ...
        client_data=ClientFieldData(
            prompt_on_new=True,
            prompt=lambda mi: "Define the short threshold for Bollinger Bands (e.g., 0.7):",
        ),
    )
...
class DirectionalTradingMACDBB(ScriptStrategyBase):
    ...
    def __init__(
        ...
        config: DirectionalTradingMACDBBConfig,
    ):
